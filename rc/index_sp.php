		...
		if (!$result) {
			...
			while ($row = mysql_fetch_array($result)){
				echo "<li class='liBody'><section><div><h1>".$row['title']."</h1><span></span></div><dl>".
					...
					"<dd><a>紹介サイト：未実装</a></dd>".
					"<dd class='noBorder'><a>概要:<br>".$row['outline']."</a></dd>".
					"<dd class='noBorder cf'><form action='del.php' method='post' id='pico_leftContents' class='add' ><input name='id' type='hidden' value='".$row['id']."'><input type='submit' value='削除'></form>".
